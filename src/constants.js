...
const BEMBA_SYNTAX = {
    ...
    PROPS: 'ificingilila',
    STATE: 'ukusunga',
    STATE_WITH_EFFECTS: 'ukusungaKabili',
    UPDATE_STATE: 'ukuCinja',
    ...
    // Event handling
    EVENTS: {
        onClick: 'pakuKlikisha',
        onChange: 'pakuLemba',
        onSubmit: 'pakuTumina',
        onSelectChange: 'pakuCinja',
        onFocus: 'pakuIngia',
        onBlur: 'pakuFuma',
        onMouseEnter: 'pakuKwesha',
    ...
    FUNCTIONS: {
        console: {
            log: 'londolola',
            error: 'londololaError',
            warn: 'londololaWarning'
        },
        string: {
            length: 'ukuPima',
            replace: 'ukuPindula',
