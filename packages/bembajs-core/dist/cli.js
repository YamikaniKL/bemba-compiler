...
class BembaCLI {
    ...
    createInitialFiles(projectPath, name, options) {
        // Create home page
        const homePageContent = `pangaIpepa('Home', {
    umutwe: 'Create BembaJS App',
    ilyashi: 'Generated by create bembajs app',
    
    // Page content - matching new Next.js grid structure
    ifiputulwa: [
        {
            umutwe: 'Get started by editing',
            ilyashi: 'Save and see your changes instantly.',
            amabatani: [
                {
                    ilembo: 'Deploy now',
    ...
    // Page styles - Exact match to new Next.js grid styling
    imikalile: \`
        * {
    ...
    \`
        ...
        // Create about page
        const aboutPageContent = `pangaIpepa('About', {
    umutwe: 'About Page',
    ilyashi: 'Learn more about this application',
    
    // Page content
    ifiputulwa: [
        {
            umutwe: 'About This App',
            ilyashi: 'This is the about page for your BembaJS application.',
            amabatani: [
                {
                    ilembo: 'Go Home',
