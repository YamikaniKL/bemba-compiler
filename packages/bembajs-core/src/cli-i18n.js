...
const MSGS = {
    en: {
        ...
        viteDevReact: 'Starting Phisha (dev — React via Injini/Vite; pages with ukwisulula)...',
        viteBuildReact: 'Building with Phisha (Injini / Vite production bundle)...',
    ...
    bem: {
        ...
        viteDevReact: 'Tungulula Phisha (ukupanga — React mu Injini/Vite; amapeji ya ukwisulula)...',
        viteBuildReact: 'Tulipanga na Phisha (Injini / Vite pa production)...',
