...
const MSGS = {
    en: {
        ...
        viteDevReact: 'Starting Vite (React app — pages with ukwisulula)...',
        viteBuildReact: 'Building with Vite (React SPA)...',
        viteBuildDone: '✅ Vite build finished.',
    ...
    bem: {
        ...
        viteDevReact: 'Tungulula Vite (React — amapeji ya ukwisulula)...',
        viteBuildReact: 'Tulipanga na Vite (React SPA)...',
        viteBuildDone: '✅ Vite yapwa.',
