...
const MSGS = {
    en: {
        ...
        fumyaDesc: 'Export static HTML site (pangaIpepa pages) to a folder',
        ...
        optLegacyNext: 'Run legacy Next.js scaffold build instead of HTML export',
        ...
        exportingHtml: 'Exporting static HTML (pangaIpepa)...',
        exportingSite: 'Exporting static HTML site...',
    ...
    bem: {
        ...
        fumyaDesc: 'Fumya HTML ukuya mu bufolder',
        ...
        exportingHtml: 'Tulifumya HTML (pangaIpepa)...',
        exportingSite: 'Tulifumya HTML ya site...',
