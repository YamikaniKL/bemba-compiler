...
const MSGS = {
    en: {
        ...
        akhaDesc: 'Build production React app (Phisha / Injini) by default; optional legacy modes available',
        fumyaDesc: 'Export build output folder (Phisha / Injini default)',
        ...
        optLegacyStatic: 'Force legacy static HTML export path (skip Phisha / Injini React app build)',
        ...
        viteDevReact: 'Starting Phisha (dev — React via Injini; pages with ukwisulula)...',
        viteBuildReact: 'Building with Phisha (Injini production bundle)...',
        viteBuildDone: '✅ Phisha build finished.',
        phishaLocalUrl: (url) => `  ➜  Phisha:  ${url}`,
    ...
    bem: {
        ...
        akhaDesc: 'Akha React app ya production (Phisha / Injini by default); pali legacy options',
        fumyaDesc: 'Fumya ifya build ku folder (Phisha / Injini default)',
        ...
        optLegacyStatic: 'Bomfya inshila yakweka ya static HTML (leka Phisha / Injini React app build)',
        ...
        viteDevReact: 'Tungulula Phisha (ukupanga — React mu Injini; amapeji ya ukwisulula)...',
        viteBuildReact: 'Tulipanga na Phisha (Injini pa production)...',
        viteBuildDone: '✅ Phisha yapwa.',
        phishaLocalUrl: (url) => `  ➜  Phisha:  ${url}`,
