...
pangaIpepa('Home', {
  ukwisulula: nokuti() {
    ...
    bwelela (
      <icipandwa style={shell}>
        <icipandwa style={card}>
          <icipandwa style={{ display: 'flex', justifyContent: 'center', marginBottom: '0.5rem' }}>
            <svg width="56" height="56" viewBox="0 0 56 56" fill="none" aria-label="BembaJS logo">
          ...
          <icipandwa>
            <ukulondolola style={{ ...muted, fontSize: '0.875rem', fontFamily: 'ui-monospace, SFMono-Regular, Menlo, monospace' }}>
              bembajs v1.0.0
            </ukulondolola>
          ...
          <icipandwa>
            <umutwe_ukalamba style={{ ...muted, fontWeight: 300, fontSize: 'clamp(1.125rem, 2.2vw, 1.5rem)' }}>
              A modern Bemba-native JavaScript framework for web development
            </umutwe_ukalamba>
            <ukulondolola style={{ ...muted, maxWidth: '40rem', margin: '1rem auto 0', lineHeight: 1.7 }}>
