...
function injiniSsrErrorLabels(projectRoot) {
    ...
    if (!bem) {
        return {
            ...
            panelTitle: 'Phisha Dev Panel',
            lead: 'Something failed while compiling or rendering this page. Details are below.',
            hint: 'Tip: fix the file, then refresh.',
            summaryHeading: 'Issue summary',
            routePill: 'route',
            quickActionsHeading: 'Quick actions',
            refreshAction: 'Refresh',
            copyAction: 'Copy error',
            hidePanelAction: 'Hide panel',
            showPanelAction: 'Show panel',
            toggleShortcutHint: 'Shortcut: Alt+Shift+D (or Ctrl+Alt+D)',
            errorHeading: 'Error',
    ...
    return {
        ...
        panelTitle: 'Akapaneli ka Phisha (dev)',
        ...
        summaryHeading: 'Ifyapwa mwachidule',
        routePill: 'route',
        quickActionsHeading: 'Ifyakuchita bwangu',
        refreshAction: 'Sansa',
        copyAction: 'Kopa ubulubulo',
        hidePanelAction: 'Fisa paneli',
        showPanelAction: 'Langisha paneli',
        toggleShortcutHint: 'Shortcut: Alt+Shift+D (nangu Ctrl+Alt+D)',
